...
public class UIMainWorld extends World
{
    ...
    private void testActors()
    {
         ...
         */
        TextBox textbox = new TextBox("Hi 2.0", 24, true, Color.WHITE, Color.BLACK);
         ...
         */
        Menu menu = new Menu("file ","New\nOpen\nSave\nClose\nExit",  18, Color.RED, Color.BLUE, Color.RED, Color.BLUE, new FileCommands());
